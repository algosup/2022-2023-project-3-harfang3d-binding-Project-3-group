...
# Test policy
## Mission of testing
This test plan outlines the project **F# bindings** for Team 3. Our ultimate goal is to bind F# to C++. The plan will be updated as the project progresses, and it aims to test all aspects of the project.
...
### Hardware used
- MacBook Air M1 running on macOS Monterey version 13.2 
